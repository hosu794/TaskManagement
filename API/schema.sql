...
-- Last modification date: 2024-07-08 16:54:03.148
...
-- Reference: SharedTask_Task (table: SharedTask)
ALTER TABLE SharedTask ADD CONSTRAINT SharedTask_Task
    FOREIGN KEY (Task_id)
    REFERENCES Task (id);

-- Reference: SharedTask_User (table: SharedTask)
ALTER TABLE SharedTask ADD CONSTRAINT SharedTask_User
    FOREIGN KEY (userId)
    REFERENCES "User" (id);
